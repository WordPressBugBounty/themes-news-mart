 ...
 */	
?>
<article class="post wow animate fadeInUp vrsn-four" data-wow-delay=".3s" <?php post_class(); ?>>		
			   <?php 
		...
		?>		
				<figcaption class="post-content">
					...
					<div class="entry-content">
						...
						<a href="<?php the_permalink();?>" class="more-link"><?php echo esc_html(get_theme_mod('newsexo_read_more_button_text', __('Read More', 'news-mart'))); ?></a>
						<?php } ?>
						<?php wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'news-mart' ), 'after'  => '</div>', ) ); ?>
					</div>
				</figcaption>	
